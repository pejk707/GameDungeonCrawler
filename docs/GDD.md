...
> Подробный архитектурный проект с UML-диаграммами (классы, последовательности, активности) — предмет Milestone 2. Здесь зафиксированы технические требования, которые вытекают из дизайна.
